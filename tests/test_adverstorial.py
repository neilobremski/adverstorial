...
def test_system_prompt_generation():
    ...
    # Test round 0 (character description)
    protagonist_prompt = dialogue._create_system_prompt("protagonist", 0, 4)
    antagonist_prompt = dialogue._create_system_prompt("antagonist", 0, 4)
    ...
    # Test final round (story writing)
    final_prompt = dialogue._create_system_prompt("protagonist", 3, 4)
    assert "complete short story" in final_prompt.lower()
